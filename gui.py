...
class gui:
    def __init__(self):
        ...
        self.green = 128
        self.alpha=100
        self.rect = pygame.Rect((0,0),(200,100)) # 0,0 should be relative to surface

        self.surface = pygame.Surface((200,100)) # total size of our drawing space
    ...
    def colorpicker(self):
        ...
        pygame.draw.rect(self.surface,(self.red,self.green,self.blue,self.alpha),self.rect)
